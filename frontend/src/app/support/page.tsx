...
import {HiChatBubbleLeftRight, HiDocumentText, HiQuestionMarkCircle, HiPhone, HiEnvelope} from "react-icons/hi2";
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 rounded-3xl border-4 border-orange-100 relative overflow-hidden">
                                ...
                                <CardHeader className="pb-4">
                                    <div className="w-16 h-16 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-2xl flex items-center justify-center mb-4 transform rotate-3 hover:rotate-0 transition-transform duration-300 relative">
                            ...
                            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 rounded-3xl border-4 border-blue-100 relative overflow-hidden">
                                ...
                                <CardHeader className="pb-4">
                                    <div className="w-16 h-16 bg-gradient-to-br from-green-100 to-emerald-100 rounded-2xl flex items-center justify-center mb-4 transform -rotate-2 hover:rotate-0 transition-transform duration-300 relative">
                                ...
                                <CardContent>
                                    ...
                                    <Button asChild className="w-full">
                                        <Link href="/support/docs">View Docs</Link>
                                    </Button>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 rounded-3xl border-4 border-green-100 relative overflow-hidden">
                                ...
                                <CardHeader className="pb-4">
                                    <div className="w-16 h-16 bg-gradient-to-br from-red-100 to-pink-100 rounded-2xl flex items-center justify-center mb-4 transform rotate-1 hover:rotate-0 transition-transform duration-300 relative">
                                ...
                                <CardContent>
                                    ...
                                    <Button asChild className="w-full">
                                        <Link href="/support/chat">Start Chat</Link>
                                    </Button>
                                </CardContent>
                            </Card>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                            <Card className="border-0 shadow-xl rounded-3xl border-4 border-orange-100 relative overflow-hidden">
                                <div className="absolute top-4 right-4 w-6 h-6 bg-yellow-300 rounded-full opacity-40 transform rotate-45"></div>
                                <CardHeader>
                            ...
                            <Card className="border-0 shadow-xl rounded-3xl border-4 border-blue-100 relative overflow-hidden">
                                <div className="absolute top-4 right-4 w-6 h-6 bg-orange-300 rounded-full opacity-40 transform -rotate-45"></div>
                                <CardHeader>
                                    <CardTitle className="text-2xl font-bold text-gray-900 flex items-center gap-3">
                        ...
                        <div className="mb-12">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl border-2 border-gray-100">
