...
import {HiArrowLeft, HiDocumentText, HiChevronDown, HiChevronUp, HiExternalLink} from "react-icons/hi2";
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="space-y-6">
                            {docSections.map((section, sectionIndex) => (
                                <Card key={sectionIndex} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl border-2 border-gray-100">
                                    <CardHeader 
                                        ...
                                        <CardContent className="pt-0">
                                            <div className="space-y-4">
                                                {section.articles.map((article, articleIndex) => (
                                                    <Card key={articleIndex} className="border-0 shadow-sm hover:shadow-md transition-all duration-300 rounded-xl border border-gray-200">
                                                        <CardHeader 
                                                            className="cursor-pointer"
                                                        ...
                                                        >
                                                            ...
                                                            <div className="flex items-center gap-4 mt-2">
                                                                <span className={`px-2 py-1 rounded-full text-xs font-semibold ${getDifficultyColor(article.difficulty)}`}>
                                                                    {article.difficulty}
                                                                </span>
                        ...
                        <div className="mt-12">
                            ...
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl border-2 border-orange-100">
                                    <CardContent className="p-6 text-center">
                                        ...
                                        <p className="text-gray-600 mb-4">Watch step-by-step video guides for all major features</p>
                                        <Button variant="outline" className="border-orange-300 text-orange-700 hover:bg-orange-50">
                                            Watch Videos
                                        </Button>
                                    </CardContent>
                                ...
                                <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl border-2 border-blue-100">
                                    <CardContent className="p-6 text-center">
                                        ...
                                        <p className="text-gray-600 mb-4">Technical documentation for developers and integrations</p>
                                ...
                                <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl border-2 border-green-100">
                                    <CardContent className="p-6 text-center">
                                        ...
                                        <p className="text-gray-600 mb-4">Learn proven strategies for success on TickTime</p>
