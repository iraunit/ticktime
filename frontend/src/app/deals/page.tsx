                                ...
                                <div className="sticky top-4 space-y-4">
                                    ...
                                    <div className="bg-white rounded-lg border shadow-sm p-3">
                                        ...
                                        <div className="text-sm text-gray-600 mb-3">
                                            ...
                                            {hasActiveFilters && (
                                                <span
                                                    className="ml-2 px-2 py-0.5 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">
                          Filtered
                        </span>
                                            )}
                                        </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            {[
                                                ...
                                                {
                                                    label: "Invited",
                                                    value: dealsData.filter(d => d.status === "invited").length,
                                                    color: "orange"
                                                },
                                                {
                                                    label: "Active",
                                                    value: dealsData.filter(d => d.status === "active").length,
                                                    color: "green"
                                                },
                                                {
                                                    label: "Completed",
                                                    value: dealsData.filter(d => d.status === "completed").length,
                                                    color: "purple"
                                                }
                                            ].map((stat, index) => (
                                                <div key={index}
                                                     className={`bg-${stat.color}-50 border border-${stat.color}-200 rounded-lg p-2`}>
                                                    <div
                                                        className={`text-lg font-bold text-${stat.color}-600`}>{stat.value}</div>
