...
export default function NotFound() {
  ...
  const dashboardUrl = user?.account_type === 'brand' ? '/brand/dashboard' : '/influencer/dashboard';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-8 bg-gradient-to-br from-gray-50 via-white to-gray-100">
      <div className="text-center max-w-md">
        {/* Error Icon */}
        <div className="w-24 h-24 bg-gradient-to-br from-red-50 to-orange-100 rounded-full flex items-center justify-center mx-auto mb-6">
