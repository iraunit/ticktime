...
export default function ProfilePage() {
  ...
  // Soft-handle missing profile (e.g., 404) as empty state with ability to create/update
  const softError = profile.isError || !profile.data;
            ...
            <div className="lg:col-span-3">
              <div className="space-y-6">
                      ...
                      <CardContent className="p-6">
                        ...
                        {softError && (
                          <div className="mt-4 text-sm text-gray-600">
                            No profile found yet. Fill in your details below to create one.
                          </div>
                        )}
                      </CardContent>
                    </Card>
                ...
                {activeSection === 'personal' && (
                  <ProfileForm profile={profile.data || undefined} />
                )}
                ...
                {activeSection === 'documents' && (
                  <DocumentUpload profile={profile.data || undefined} />
                )}
              </div>
            </div>
          </div>
