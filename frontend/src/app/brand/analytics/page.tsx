                    ...
                    <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 p-4">
                        <div>
                            ...
                            <p className="text-sm text-gray-600 max-w-2xl">
                                Comprehensive insights into your campaign performance, audience engagement, and ROI
                                metrics.
                            </p>
                        </div>
                    ...
                    <TabsContent value="overview" className="space-y-6">
                        {isLoading ? (
                                        ...
                                        <CardContent className="p-6">
                                            <div className="flex items-center justify-between">
                                                <div className="flex-1">
                                                    ...
                                                    {overallAnalytics.total_reach === 0 ? (
                                        ...
                                        <CardContent className="p-6">
                                            <div className="flex items-center justify-between">
                                                <div className="flex-1">
                                                    ...
                                                    {overallAnalytics.total_engagement === 0 ? (
                                                        <Badge variant="outline"
                                                               className="text-xs bg-blue-50 text-blue-600 border-blue-200">
                                                            Upcoming Feature
                                                        </Badge>
                            ...
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-500 mb-4">Start creating and running campaigns to see your
                                    analytics.</p>
                                <Button
                    ...
                    <TabsContent value="campaigns" className="space-y-6">
                        {isLoading ? (
                                        ...
                                        <CardContent>
                                            ...
                                            {selectedCampaign?.id === campaign.id && (
                                                <div className="border-t pt-6 space-y-6">
                                                    ...
                                                    <div>
                                                        <h4 className="font-semibold text-gray-900 mb-4">Top Performing
                                                            Content</h4>
                                                                ...
                                                                <div key={index}
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div className="flex items-center gap-2 mt-1">
                                                                            ...
                                                                            <span
                                                                                className="text-xs text-gray-500">{content.content_type}</span>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                        <div>
                                                            <h4 className="font-semibold text-gray-900 mb-4">Age
                                                                Demographics</h4>
                                                                ...
                                                                {campaign.demographics.age_groups.map((age, index) => (
                                                                    <div key={index}
                                                                        ...
                                                                        <div className="flex items-center gap-2">
                                                                            ...
                                                                            <span
                                                                                className="text-sm font-medium">{formatPercentage(age.percentage)}</span>
                                                                        </div>
                                                                    </div>
                                                                ))}
                                                            </div>
                                                        ...
                                                        <div>
                                                            <h4 className="font-semibold text-gray-900 mb-4">Top
                                                                Locations</h4>
                                                            <div className="space-y-2">
                                                                {campaign.demographics.locations.map((location, index) => (
                                                                    <div key={index}
                                                                         className="flex items-center justify-between">
                                                                        <span
                                                                            className="text-sm">{location.country}</span>
                                                                        <div className="flex items-center gap-2">
                                                                            <div
                                                                                className="w-24 h-2 bg-gray-200 rounded">
                                                                                <div
                                                                            ...
                                                                            <span
                                                                                className="text-sm font-medium">{formatPercentage(location.percentage)}</span>
                                                                        </div>
                                                                    </div>
                                                                ))}
                                                            </div>
                            ...
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-500 mb-4">Create and launch campaigns to see detailed
                                    analytics.</p>
                                <Button
                                    onClick={() => window.location.href = '/brand/campaigns/create'}
                                    className="bg-blue-600 hover:bg-blue-700 text-white"
                                                    ...
                                                    {overallAnalytics?.demographics?.genders?.map((gender, index) => (
                                                        <div key={index} className="flex items-center justify-between">
                                                            ...
                                                            <div className="flex items-center gap-2">
                                                                ...
                                                                <span
                                                                    className="text-sm font-medium">{formatPercentage(gender.percentage)}</span>
                                                            </div>
                                                        </div>
                                                    )) || (
                                                        <p className="text-sm text-gray-500">No gender data
                                                            available</p>
                                                    )}
                                                </div>
                                            </div>
                                                    ...
                                                    {overallAnalytics?.demographics?.devices?.map((device, index) => (
                                                        <div key={index} className="flex items-center justify-between">
                                                            ...
                                                            <div className="flex items-center gap-2">
                                                                ...
                                                                <span
                                                                    className="text-sm font-medium">{formatPercentage(device.percentage)}</span>
                                                            </div>
                                                        </div>
                                                    )) || (
                                                        <p className="text-sm text-gray-500">No device data
                                                            available</p>
                                                    )}
                                                </div>
                                            </div>
