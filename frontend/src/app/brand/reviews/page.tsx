...
export default function BrandReviewsPage() {
  ...
  const getActiveReviews = () => {
    return activeTab === 'given' ? reviewsGiven : reviewsReceived;
  };
    ...
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-4 max-w-7xl">
        ...
        <div className="relative mb-6">
          <div className="absolute inset-0 bg-gradient-to-r from-yellow-500/5 via-orange-500/5 to-red-500/5 rounded-xl -m-2"></div>
            ...
            {isLoading ? (
              ...
              <div className="space-y-4">
                {reviewsReceived.map((review) => (
                  <Card key={review.id} className="shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="text-right">
                          <Badge variant={review.is_public ? "default" : "secondary"} className="mb-2">
                      ...
                      {review.response && (
                        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="font-medium text-gray-900">Influencer Response</span>
