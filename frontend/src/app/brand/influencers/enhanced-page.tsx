...
export default function EnhancedInfluencerSearchPage() {
  ...
  const handleBookmark = (influencerId: number) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-6 max-w-7xl">
          ...
          <div className="p-4">
            ...
            <div className="flex items-center gap-4 flex-wrap">
              ...
              <div className="flex items-center gap-2">
                <div className={`w-8 h-8 rounded-lg bg-gradient-to-r ${platformConfig[selectedPlatform as keyof typeof platformConfig]?.color} flex items-center justify-center text-white text-sm`}>
            ...
            <div className="p-6">
              ...
              <div className="grid gap-6">
                ...
                <p className="text-sm text-gray-500 italic">
                  Note: Profiles matching any of the three — category, keyword, or bio — will be shown.
                </p>
                ...
                {influencers.map((influencer, index) => (
                  ...
                  >
                    <td className="px-4 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-gradient-to-br from-gray-200 to-gray-300 rounded-full overflow-hidden">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                  <div className="bg-blue-50 p-4 rounded-lg">
                                    <div className="flex items-center gap-2 mb-1">
                                      ...
                                      <span className="text-sm text-blue-600">Subscribers</span>
                                    </div>
        ...
        <div className="fixed right-4 top-1/2 transform -translate-y-1/2 w-64 bg-white border border-gray-200 rounded-lg shadow-lg p-4 hidden xl:block">
                          <h3 className="text-lg font-semibold text-gray-900 mb-4">Improve your efficiency with our platform!</h3>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Maybe a way to communicate plan & list hierarchy.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Reach out to influencers & get their updated costs.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Download influencer lists with their metrics on an excel sheet!</p>
              </div>
            </div>
          </div>
