...
import {getPlatformLabel, platformConfig, platformOptions} from "@/lib/platform-config";
        ...
        <div className="min-h-screen">
            <div className="container mx-auto px-4 py-4 max-w-7xl">
                ...
                <div className="relative mb-6">
                    <div
                        className="absolute inset-0 bg-gradient-to-r from-red-500/5 via-orange-500/5 to-red-500/5 rounded-xl -m-2"></div>
                    ...
                    <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 p-4">
                        <div>
                            ...
                            <p className="text-sm text-gray-600 max-w-2xl">
                                Create, manage, and track your influencer marketing campaigns with comprehensive
                                analytics.
                            </p>
                        </div>
                ...
                {/* Search and Filters */}
                <Card
                    className="mb-6 bg-gradient-to-br from-white via-white to-gray-50 border border-gray-200 shadow-md">
                    <div className="p-4">
                        {/* Search Bar */}
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <Select value={platform} onValueChange={setPlatform}>
                                        ...
                                        <SelectContent>
                                            ...
                                            {platformOptions.map(({value, label, icon: IconComponent, color}) => (
                                            ...
                                            <div className="flex items-center gap-3 mb-1">
                                                ...
                                                <div className="flex gap-1">
                                                    {daysUntilDeadline <= 3 && daysUntilDeadline > 0 && (
                                                        <Badge
                                                            className="bg-orange-100 text-orange-700 text-xs animate-pulse">
                                                    ...
                                                    {(() => {
                                                        ...
                                                        if (isUpcoming) return <Badge
                                                            className="bg-blue-100 text-blue-800 text-xs">🚀
                                                            Upcoming</Badge>;
                                                        if (isPast) return <Badge
                                                            className="bg-gray-100 text-gray-800 text-xs">📅
                                                            Past</Badge>;
                                                        return <Badge className="bg-green-100 text-green-800 text-xs">✨
                                                            Live</Badge>;
                                                    })()}
                                                </div>
                                            </div>
                          ...
                          <span className="inline-flex items-center gap-1.5 font-medium">
                            ...
                            Goes Live: {formatDate(campaign.campaign_live_date)}
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                                        <div
                                            className="rounded-lg p-3 bg-gradient-to-br from-emerald-50 to-green-50 border border-green-200/50">
                                        ...
                                        <div
                                            className="rounded-lg p-3 bg-gradient-to-br from-purple-50 to-indigo-50 border border-purple-200/50">
                                        ...
                                        <div
                                            className="rounded-lg p-3 bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200/50">
                                        ...
                                        <div
                                            className="rounded-lg p-3 bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-200/50">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex gap-1">
                                            {(campaign.platforms_required || []).map((platformId, i) => {
                                                ...
                                                if (!config) return <Badge key={`${platformId}-${i}`} variant="outline"
                                                                           className="text-xs px-1">{platformId}</Badge>;
                                                ...
                                                return (
                                                    <div key={`${platformId}-${i}`}
                                                         ...
                                                         title={getPlatformLabel(platformId)}>
                        ...
                        {page < totalPages && (
                            <div className="flex justify-center">
                                <Button onClick={() => {
                                    ...
                                    fetchCampaigns(page + 1, true).finally(() => setIsLoadingMore(false));
