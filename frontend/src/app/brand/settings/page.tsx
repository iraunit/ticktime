               ...
               <div className="space-y-4">
                 <div className="flex items-center space-x-4">
                   <div className="w-20 h-20 bg-gray-100 rounded-lg flex items-center justify-center overflow-hidden">
                     ...
                     <div className={`w-full h-full flex items-center justify-center text-gray-400 ${brand?.logo ? 'hidden' : ''}`}>
         ...
         <TabsContent value="profile" className="space-y-6">
           ...
           <Card className="p-6">
             <div className="space-y-6">
                               {/* Profile Avatar */}
                <div className="flex items-center space-x-4">
                  <div className="w-20 h-20 bg-gradient-to-br from-red-500 via-orange-500 to-red-600 rounded-full flex items-center justify-center shadow-lg overflow-hidden">
                    ...
                    <span className={`text-2xl font-bold text-white ${currentUser?.profile_image ? 'hidden' : ''}`}>
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">
                      Member since {currentUser?.date_joined ? new Date(currentUser.date_joined).toLocaleDateString() : 'N/A'}
                    </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    {isEditingProfile ? (
                      ...
                      <div className="p-3 bg-gray-50 rounded-md border">
                        <span className="text-gray-900">{currentUser?.first_name || 'Not set'}</span>
                      </div>
                    )}
                  </div>
                ...
                <div className="border-t pt-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      {isEditingProfile ? (
                        ...
                        <div className="p-3 bg-gray-50 rounded-md border">
                          <span className="text-gray-900">{currentUser?.country || 'Not set'}</span>
                        </div>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {isEditingProfile ? (
                        <Select value={userState} onValueChange={setUserState} disabled={locationLoading}>
                          <SelectTrigger>
                    ...
                    <div>
                      ...
                      {isEditingProfile ? (
                        <Select value={userCity} onValueChange={setUserCity} disabled={locationLoading}>
                          <SelectTrigger>
                            <SelectValue placeholder={locationLoading ? "Loading cities..." : "Select city"} />
                          </SelectTrigger>
                          <SelectContent>
                            {cities.map((city) => (
                    ...
                    <div>
                      ...
                      {isEditingProfile ? (
                        ...
                        <div className="p-3 bg-gray-50 rounded-md border">
                          <span className="text-gray-900">{currentUser?.zipcode || 'Not set'}</span>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="mt-6">
                    ...
                    {isEditingProfile ? (
                      ...
                      <div className="p-3 bg-gray-50 rounded-md border">
                        <span className="text-gray-900">{currentUser?.address_line1 || 'Not set'}</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="mt-6">
                    ...
                    {isEditingProfile ? (
                      ...
                      <div className="p-3 bg-gray-50 rounded-md border">
                        <span className="text-gray-900">{currentUser?.address_line2 || 'Not set'}</span>
                      </div>
                    )}
                  </div>
                </div>
            ...
            {isLoadingDomainUsers ? (
              ...
              <div className="space-y-3">
                <p className="text-sm text-gray-600">
                  Found {domainUsers.length} user(s) with the same domain who are not yet team members.
                </p>
