        ...
        <div className="space-y-4 sm:space-y-6">
            ...
            <div className="bg-white rounded-xl border shadow-lg p-4 sm:p-6">
                <div className="flex items-start sm:items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
                    <div
                        className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
                        <HiCalendarDays className="w-4 h-4 sm:w-5 sm:h-5 text-white"/>
                    </div>
                    <div>
                        <h2 className="text-lg sm:text-xl font-bold text-gray-900 leading-tight">Collaboration
                            History</h2>
                        <p className="text-sm sm:text-base text-gray-600 leading-relaxed">Track your past collaborations
                            and performance</p>
                    </div>
                </div>
            </div>
            ...
            <Card className="rounded-xl border shadow-lg">
                <CardHeader className="p-4 sm:p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                        <div className="flex items-center gap-3">
                            <div
                                className="w-8 h-8 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-lg flex items-center justify-center shadow-md">
                                <HiFunnel className="w-4 h-4 text-white"/>
                            </div>
                            <div>
                                <CardTitle className="text-base sm:text-lg font-bold text-gray-900">Filter &
                                    Export</CardTitle>
                ...
                <CardContent className="p-4 sm:p-6">
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                        <div>
                            <label
                                className="text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2 block">Status</label>
                        ...
                        <div>
                            <label
                                className="text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2 block">Brand</label>
                        ...
                        <div className="flex items-end">
                            <div className="w-full">
                                <label
                                    className="text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2 block">Results</label>
                                <div
                                    className="px-3 py-2 bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-md text-sm font-medium text-blue-800">
                ...
                {filteredCollaborations.length > 0 ? (
                    filteredCollaborations.map((collaboration: CollaborationHistoryType) => (
                        <Card key={collaboration.id}
                              className="rounded-xl border shadow-lg hover:shadow-xl transition-all duration-200">
                            <CardContent className="p-4 sm:p-6">
                                <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                                    {/* Brand Logo */}
                                    <div className="flex items-center gap-3 flex-1">
                                        <div
                                            className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg sm:rounded-xl flex items-center justify-center shadow-md flex-shrink-0">
                        ...
                        ₹{collaboration.total_value.toLocaleString()}
                                        ...
                                        {/* Status */}
                                        <Badge
                                            className={`px-2 py-1 text-xs font-medium border ${getStatusColor(collaboration.status)}`}>
                                        ...
                                        <div className="flex flex-col sm:items-end gap-1">
                                            {collaboration.rating && (
                                                <div className="flex items-center gap-1">
                                                    ...
                                                    <span
                                                        className="text-xs font-medium text-gray-700">{collaboration.rating}/5</span>
                                                </div>
                                            )}
                                            {collaboration.completed_at && (
                                                <div className="flex items-center gap-1">
                    ...
                    <div className="text-center py-12 sm:py-16">
                        <div
                            className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
                            <HiCalendarDays className="w-8 h-8 sm:w-10 sm:h-10 text-gray-400"/>
                        </div>
                        <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">No collaborations
                            found</h3>
