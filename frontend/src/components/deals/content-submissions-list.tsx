            ...
            <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                    <CardTitle className="flex items-center space-x-2">
                        <div
                            className="w-6 h-6 bg-gradient-to-r from-pink-500 to-purple-500 rounded-lg flex items-center justify-center">
                            ...
                            {submission.last_revision_update
                                ...
                                {submission.feedback && (
                                    <div className="mb-3 border-t pt-3">
                                        <h5 className="font-medium text-sm text-gray-900 mb-2">Latest Brand
                                            Feedback</h5>
                                        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                                            <p className="text-sm text-yellow-800">{submission.feedback}</p>
                                            {submission.revision_notes && (
                                                <div className="mt-2 pt-2 border-t border-yellow-200">
                                                    <p className="text-xs font-medium text-yellow-900">Revision
                                                        Notes:</p>
