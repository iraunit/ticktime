...
const statusOptions: { value: string; label: string; color: string }[] = [
    ...
    {value: "address_requested", label: "Address Requested", color: "orange"},
    {value: "address_provided", label: "Address Provided", color: "lime"},
    {value: "product_shipped", label: "Product Shipped", color: "indigo"},
    {value: "product_delivered", label: "Product Delivered", color: "teal"},
    ...
    {value: "revision_requested", label: "Revision Requested", color: "amber"},
    {value: "approved", label: "Approved", color: "emerald"},
    {value: "completed", label: "Completed", color: "gray"},
    {value: "rejected", label: "Rejected", color: "red"},
    {value: "cancelled", label: "Cancelled", color: "slate"},
    {value: "dispute", label: "Dispute", color: "pink"},
];

const dealTypeOptions = [
    {value: "all", label: "All Types"},
    {value: "cash", label: "Cash Payment"},
    {value: "product", label: "Barter Only"},
    {value: "hybrid", label: "Cash + Barter"},
];
                ...
                <div className="space-y-3">
                    ...
                    <div>
                        ...
                        <Select value={statusFilter} onValueChange={onStatusFilterChange}>
                            <SelectTrigger
                                className="border border-gray-200 focus:border-blue-500 rounded-md py-1.5 text-sm">
                        ...
                        <div className="flex flex-col space-y-1.5">
                            ...
                            {searchQuery && (
                                <Badge variant="secondary"
                                       className="bg-blue-100 text-blue-800 text-xs px-1.5 py-0.5 self-start">
                                    Search: "{searchQuery}"
                                    <button
                            ...
                            {statusFilter !== "all" && (
                                <Badge variant="secondary"
                                       className="bg-green-100 text-green-800 text-xs px-1.5 py-0.5 self-start">
                            ...
                            {dealTypeFilter !== "all" && (
                                <Badge variant="secondary"
                                       className="bg-purple-100 text-purple-800 text-xs px-1.5 py-0.5 self-start">
