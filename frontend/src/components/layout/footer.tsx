                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-gray-400 mb-3 max-w-md text-sm">
                            The ultimate platform for influencers to connect with brands, manage collaborations, and
                            grow their business.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-1.5 text-sm">
                            ...
                            <li>
                                <Link href="/brand/deals" className="text-gray-400 hover:text-white transition-colors">
                                    Deals
                                </Link>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-1.5 text-sm">
                            ...
                            <li>
                                <Link href="/support/chat" className="text-gray-400 hover:text-white transition-colors">
                                    Contact Us
                                </Link>
                            </li>
                            <li>
