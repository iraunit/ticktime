                ...
                return (
                    <div className="space-y-6">
                        <div className="flex items-center gap-2 mb-6">
                            ...
                            <h3 className="text-sm font-semibold text-gray-700 uppercase tracking-wide">Personal
                                Information</h3>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <div className="col-span-2">
                                <FormField
                                    ...
                                    render={({field}) => (
                                        <FormItem>
                                            <FormLabel className="text-sm font-medium text-gray-700">Phone
                                                Number</FormLabel>
                                            <FormControl>
                                                <div className="relative">
                ...
                return (
                    <div className="space-y-6">
                        <div className="flex items-center gap-2 mb-6">
                            ...
                            <h3 className="text-sm font-semibold text-gray-700 uppercase tracking-wide">Content
                                Category</h3>
                        </div>
                        ...
                        <FormField
                            ...
                            render={({field}) => (
                                <FormItem>
                                    <FormLabel className="text-sm font-medium text-gray-700">Primary Content
                                        Category</FormLabel>
                ...
                <div className="min-h-[calc(100vh-12rem)] flex items-center justify-center">
                    <div className="w-full max-w-lg">
                        ...
                        <div className="relative mb-8">
                            ...
                            <div
                                className="absolute inset-0 bg-gradient-to-r from-purple-500/5 via-pink-500/5 to-purple-500/5 rounded-xl -m-2"></div>
                            ...
                            <div className="relative text-center p-4">
                                <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 bg-clip-text text-transparent mb-2 flex items-center justify-center gap-2">
                                    ...
                                    <div
                                        className="w-8 h-8 bg-gradient-to-r from-purple-500 to-pink-600 rounded-lg flex items-center justify-center shadow-lg">
                        ...
                        <div className="mb-8">
                            <div className="flex items-center justify-between mb-2">
                                <span
                                    className="text-sm font-medium text-gray-600">Step {currentStep} of {steps.length}</span>
                        ...
                        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
                            <CardHeader className="space-y-1 text-center pb-6">
                                <CardTitle
                                    className="text-xl font-semibold text-gray-900">{currentStepData.title}</CardTitle>
                            ...
                            <CardContent className="space-y-6">
                                <Form {...form}>
                                    <form key={`step-${currentStep}`} onSubmit={form.handleSubmit(onSubmit)}
                                          className="space-y-6">
                                        {renderStepContent()}
