                  ...
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-2 mb-4">
                        ...
                        <h3 className="text-sm font-semibold text-gray-700 uppercase tracking-wide">Brand Information</h3>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-sm font-medium text-gray-700">Brand Name</FormLabel>
                              <FormControl>
                                <Input {...field} placeholder="Your brand name" className="h-11 border-gray-200 focus:border-blue-500 focus:ring-blue-500/20" />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input {...field} placeholder="https://yourbrand.com" className="h-11 border-gray-200 focus:border-blue-500 focus:ring-blue-500/20" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-sm font-medium text-gray-700">Brand Description</FormLabel>
                            <FormControl>
                              <Textarea 
                                {...field} 
                    ...
                    <div className="space-y-4">
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input {...field} placeholder="First name" className="h-11 border-gray-200 focus:border-blue-500 focus:ring-blue-500/20" />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input {...field} placeholder="Last name" className="h-11 border-gray-200 focus:border-blue-500 focus:ring-blue-500/20" />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input {...field} type="email" placeholder="you@yourbrand.com" className="h-11 border-gray-200 focus:border-blue-500 focus:ring-blue-500/20" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-sm font-medium text-gray-700">Country Code</FormLabel>
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <FormControl>
                                  <SelectTrigger className="h-11 border-gray-200 focus:border-blue-500 focus:ring-blue-500/20">
