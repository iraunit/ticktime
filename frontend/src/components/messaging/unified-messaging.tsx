                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">
                            {dealParam ? (
                                selectedConversation ? (
                                    <>
                                        Collaboration with <span
                                        className="font-medium text-blue-600">{selectedConversation.brand_name}</span>
                                        <span
                                            className="ml-2 px-2 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium">
                      Deal #{dealParam}
                    </span>
                                    </>
                            ...
                            {campaignParam && (
                                <span
                                    className="ml-2 px-2 py-1 bg-purple-100 text-purple-700 rounded-full text-xs font-medium">
                        ...
                        <div className="px-4 py-3 border-b border-gray-200 bg-gray-50">
                            <div className="flex items-center space-x-3">
                                {selectedConversation.brand_logo ? (
                                    ...
                                    <div
                                        className={`w-10 h-10 bg-gradient-to-r ${colors.gradient} rounded-full flex items-center justify-center`}>
                    <span className="text-sm font-bold text-white">
                      {getDisplayAvatar(selectedConversation)}
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">
                                        with <span
                                        className="font-medium text-blue-600">{getDisplayName(selectedConversation)}</span>
                            ...
                            {isLoadingMessages ? (
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-gray-500 text-sm">
                                        Send your first message about <span
                                        className="font-medium">"{selectedConversation.deal_title}"</span> to <span
                                        className="font-medium text-blue-600">{selectedConversation.brand_name}</span>.
                                    </p>
                                </div>
                            ) : (
                        ...
                        <div className="border-t border-gray-200 p-2 bg-white flex-shrink-0">
                            <div className="flex items-center space-x-2">
                                ...
                                <Button
                                    ...
                                    className={`${colors.button} h-9 px-3`}
                                    size="sm"
                                >
                            ...
                            <div className="w-1/3 bg-white border-r border-gray-200 flex flex-col">
                                ...
                                <div className="flex-1 overflow-y-auto">
                                    {isLoading ? (
                                        ...
                                        <div className="p-8 text-center">
                                            <HiChatBubbleLeftRight className="w-12 h-12 text-gray-300 mx-auto mb-4"/>
                                            <h3 className="text-lg font-medium text-gray-900 mb-2">No conversations
                                                yet</h3>
                                                                        ...
                                                                        <div className="flex-1">
                                                                            <p className="text-xs truncate">
                                                                                {dealParam && getInfluencerDealId(conversation)?.toString() === dealParam ? (
                                                                                    <>
                                      <span
                                          className="bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full text-xs font-medium mr-1">
                                        🎯 Deal #{dealParam}
                                      </span>
                                                                                        <span
                                                                                            className="text-purple-600 font-medium">{conversation.deal_title}</span>
                                                                                    </>
                                                                                ) : (
                                                                                    <span
                                                                                        className="text-purple-600 font-medium">{conversation.deal_title}</span>
                                                                            ...
                                                                            {userType === 'brand' && conversation.influencer_name && (
                                                                                <p className="text-xs text-orange-600 font-medium">
                                                                                    with {conversation.influencer_name}
                                                                                </p>
                                                                            )}
                                                                            {userType === 'influencer' && conversation.brand_name && (
                                                                                <p className="text-xs text-green-600 font-medium">
                                                                                    from {conversation.brand_name}
                                                                                </p>
                                                                            )}
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div className="flex items-center justify-between">
                                                                        <p className="text-sm text-gray-700 truncate flex-1">
                                                                            {conversation.last_message?.sender_type === userType ? (
                                                                                <span
                                                                                    className="text-gray-500">You: </span>
                                                                            ) : ''}
                                                                            {conversation.last_message?.content || 'No messages yet'}
                                                                        </p>
                                                                        {conversation.unread_count > 0 && (
                                                                            <div
                                                                                className={`w-5 h-5 ${colors.unread} text-white text-xs rounded-full flex items-center justify-center ml-2 font-bold`}>
                                            ...
                                            {isLoadingMessages ? (
                                                ...
                                                <div className="flex items-center justify-center h-full">
                                                    <div className="text-center">
                                                        ...
                                                        <p className="text-sm text-gray-400">Start the conversation
                                                            below</p>
                                                    </div>
                                                </div>
                                            ) : (
                                                    ...
                                                    >
                                                        <div className="max-w-xs lg:max-w-md">
                                                            ...
                                                            >
                                                                ...
                                                                <div
                                                                    className={`flex items-center mt-1 space-x-1 ${message.sender_type === userType ? 'justify-end' : 'justify-start'}`}>
                              <span
                                  className={`text-xs ${message.sender_type === userType ? colors.text : 'text-gray-500'}`}>
                                {formatTime(message.created_at)}
                              </span>
                                                                    {message.sender_type === userType && (
                                        ...
                                        <div className="p-2 bg-white border-t border-gray-200 flex-shrink-0">
                                            <div className="flex items-center gap-2">
                                                <div
                                                    className="flex-1 bg-gray-100 rounded-full px-3 py-2 flex items-center">
                                                    <Input
                                                        placeholder="Type a message..."
                                                        value={newMessage}
                                                        onChange={(e) => setNewMessage(e.target.value)}
                                                        onKeyPress={handleInputKeyPress}
                                                        className="flex-1 border-0 bg-transparent focus:ring-0 focus:outline-none p-0 h-6"
                                                    />
                                                </div>
                                                <Button
                                                    onClick={sendMessage}
                                                    disabled={!newMessage.trim()}
                                                    className={`${colors.button} text-white rounded-full p-2 h-8 w-8`}
                                                >
                                                    <HiPaperAirplane className="w-4 h-4"/>
                                                </Button>
                                            </div>
                                                ...
                                                {Array.from({length: 5}).map((_, i) => (
                                                    <div key={i} className="animate-pulse">
                                                        <div className="flex items-center space-x-3 p-3">
                                                            ...
                                                            <div className="flex-1">
                                                                <div
                                                                    className="h-4 bg-gray-200 rounded w-3/4 mb-2"></div>
                                                                <div className="h-3 bg-gray-200 rounded w-1/2"></div>
                                                            </div>
                                                        </div>
                                                    </div>
