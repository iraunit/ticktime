...
export const DEAL_TYPES = [
    {value: 'cash', label: 'Cash Payment', description: 'Cash payment for content creation'},
    {value: 'product', label: 'Barter Only', description: 'Product exchange for content creation'},
    {value: 'hybrid', label: 'Cash + Barter', description: 'Combination of cash and products'},
];
