...
urlpatterns = [
    ...
    path('<int:deal_id>/content-submissions/<int:submission_id>/', views.content_submission_detail_view,
         name='content_submission_detail'),

    # Brand review endpoints
    path('<int:deal_id>/content-submissions/<int:submission_id>/review/', views.content_review_view,
         name='content_review'),
