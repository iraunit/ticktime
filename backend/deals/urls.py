...
urlpatterns = [
    ...
    path('deals/<int:deal_id>/submit-content/', views.submit_content_placeholder, name='submit_content_legacy'),
    # Legacy endpoint for compatibility
    path('deals/<int:deal_id>/content-submissions/', views.content_submissions_placeholder,
         name='content_submissions_legacy'),  # Legacy endpoint for compatibility
