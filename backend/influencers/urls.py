...
urlpatterns = [
    ...
    path('profile/social-accounts/<int:account_id>/', views.social_media_account_detail_view,
         name='social_media_account_detail'),
    path('profile/social-accounts/<int:account_id>/toggle-status/', views.toggle_social_account_status_view,
         name='toggle_social_account_status'),
    ...
    path('<int:influencer_id>/refresh/', views.refresh_influencer_profile_view, name='refresh_influencer_profile'),
